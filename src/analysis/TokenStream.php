...
class TokenStream implements \ArrayAccess, \Countable, \SeekableIterator
{
    ...
    public function getType($index = null)
    {
        ...
        return isset($this->_data[$index]) ? $this->_data[$index][0] : null;
    }
    ...
    public function getValue($index = null)
    {
        ...
        return isset($this->_data[$index]) ? $this->_data[$index][1] : null;
    }
    ...
    public function skipWhitespaces($skipComment = false)
    {
        ...
        if (!$skipComment) {
            $skip += [T_COMMENT => true, T_DOC_COMMENT => true];
        }
        ...
        while ($this->_current < $count) {
            if (!isset($skip[$this->_data[$this->_current][0]])) {
                break;
            }
            $spaces .= $this->_data[$this->_current][1];
            $this->_current++;
        }
        return $spaces;
    }
