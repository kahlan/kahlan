...
class Simple extends \kahlan\fixture\Parent
{
    ...
    {$__KPOINTCUT_ARGS__ = func_get_args(); $__KPOINTCUT_SELF__ = isset($this) ? $this : get_called_class(); if ($__KPOINTCUT__ = \kahlan\plugin\Pointcut::before(__METHOD__, $__KPOINTCUT_SELF__, $__KPOINTCUT_ARGS__)) { return $__KPOINTCUT__($__KPOINTCUT_SELF__, $__KPOINTCUT_ARGS__); }
    }
