...
}class InspectorKLAYER extends \\Kahlan\\Analysis\\Inspector {    public static function inspect(string \$class) : object {\$__KPOINTCUT_ARGS__ = func_get_args(); \$__KPOINTCUT_SELF__ = isset(\$this) ? \$this : get_called_class(); if (\$__KPOINTCUT__ = \\Kahlan\\Plugin\\Pointcut::before(__METHOD__, \$__KPOINTCUT_SELF__, \$__KPOINTCUT_ARGS__)) { \$r = \$__KPOINTCUT__(\$__KPOINTCUT_ARGS__, \$__KPOINTCUT_SELF__); return \$r; }return parent::inspect(\$class);}    public static function parameters(string \$class, string \$method, ?array \$data = NULL) : array {\$__KPOINTCUT_ARGS__ = func_get_args(); \$__KPOINTCUT_SELF__ = isset(\$this) ? \$this : get_called_class(); if (\$__KPOINTCUT__ = \\Kahlan\\Plugin\\Pointcut::before(__METHOD__, \$__KPOINTCUT_SELF__, \$__KPOINTCUT_ARGS__)) { \$r = \$__KPOINTCUT__(\$__KPOINTCUT_ARGS__, \$__KPOINTCUT_SELF__); return \$r; }return parent::parameters(\$class, \$method, \$data);}    public static function typehint(\\ReflectionParameter \$parameter) : string {\$__KPOINTCUT_ARGS__ = func_get_args(); \$__KPOINTCUT_SELF__ = isset(\$this) ? \$this : get_called_class(); if (\$__KPOINTCUT__ = \\Kahlan\\Plugin\\Pointcut::before(__METHOD__, \$__KPOINTCUT_SELF__, \$__KPOINTCUT_ARGS__)) { \$r = \$__KPOINTCUT__(\$__KPOINTCUT_ARGS__, \$__KPOINTCUT_SELF__); return \$r; }return parent::typehint(\$parameter);}}
